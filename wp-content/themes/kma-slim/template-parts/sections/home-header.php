    ...
    <div class="container">
        <div class="columns hero-content is-mobile">
            <div class="column hero-item is-5-tablet is-4-desktop">
                <h1 class="title is-1">Stay Cool & Save Money</h1>
                <p class="subtitle">PowerBoost AC is a remarkably simple, proven way to keep your home cooler using less energy and saving you money.</p>
