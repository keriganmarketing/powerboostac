...
<div class="container has-text-centered">
    <p class="copyright" style="display: flex; justify-content: space-between">&copy;<?php echo date('Y'); ?> <?php echo get_bloginfo(); ?>. All&nbsp;Rights&nbsp;Reserved. <span>LIC# CAC1818012</span>
        <span class="siteby">
