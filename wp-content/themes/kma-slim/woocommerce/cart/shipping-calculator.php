    ...
    <section class="shipping-calculator-form" style="display:none;">
        ...
        <p class="form-row form-row-wide" id="calc_shipping_state_field">
            ...
            if (is_array($states) && empty($states)) {
                ...
                ?><input type="text" class="input input-text" value="<?php echo esc_attr($current_r); ?>"
        ...
        <p>
            <button type="submit" name="calc_shipping" value="1" class="button"><?php esc_html_e('Update totals',
                    'woocommerce'); ?></button>
        </p>
